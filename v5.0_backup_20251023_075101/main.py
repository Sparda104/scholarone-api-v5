...
# -*- coding: utf-8 -*-
"""
ScholarOne - Desktop App (V5 ENHANCED VERSION)
Enhanced with multi-site isolation and fault tolerance
"""
...
WEB_WRAPPER_VERSION = "V5 - Enhanced Version (Multi-Site Isolation)"

class ScholarOneApp:
    def __init__(self) -> None:
        # ---- Simple Logging --------------------------------------------------
        self.logger = logging.getLogger("s1_app_v5")
        ...
        # ---- Tk root ---------------------------------------------------------
        self.root = tk.Tk()
        self.root.title("ScholarOne API Client - V5 Enhanced")
    ...
    def _create_summary(self, sites_completed, sites_failed):
        ...
        if sites_completed:
            ...
            for site_info in sites_completed:
                ...
                lines.append(f"  [OK] {site}: {count} records")
    ...
    def run_job(self) -> None:
        ...
        Enhanced with V5 multi-site isolation capability.
        """
        print("\n=== STARTING V5 ENHANCED EXPORT ===")
        ...
        try:
            ...
            # ---- V5 Enhanced Execution with Site Isolation ---------------------
            ...
            # Process each site with isolation
            ...
            if all_rows:
                ...
                # V5 EXPORT with data pipeline (flatten + explode happens in exporter)
